  ...
  const coursePaths = [
    {
      ...
      icon: BookOpen,
      color: "bg-trimtab-gray-3",
      textColor: "text-trimtab-gray-3",
      bgColor: "bg-trimtab-gray-0",
      borderColor: "border-trimtab-gray-2",
      courses: [
    ...
    },
    {
      ...
      icon: Rocket,
      color: "bg-apest-apostle",
      textColor: "text-apest-apostle",
      bgColor: "bg-apest-apostle/10",
      borderColor: "border-apest-apostle/30",
      courses: [
    ...
    },
    {
      ...
      icon: Compass,
      color: "bg-apest-prophet",
      textColor: "text-apest-prophet",
      bgColor: "bg-apest-prophet/10",
      borderColor: "border-apest-prophet/30",
      courses: [
    ...
    },
    {
      ...
      icon: MessageCircle,
      color: "bg-apest-evangelist",
      textColor: "text-apest-evangelist",
      bgColor: "bg-apest-evangelist/10",
      borderColor: "border-apest-evangelist/30",
      courses: [
    ...
    },
    {
      ...
      icon: Heart,
      color: "bg-apest-shepherd",
      textColor: "text-apest-shepherd", 
      bgColor: "bg-apest-shepherd/10",
      borderColor: "border-apest-shepherd/30",
      courses: [
    ...
    },
    {
      ...
      icon: GraduationCap,
      color: "bg-apest-teacher",
      textColor: "text-apest-teacher",
      bgColor: "bg-apest-teacher/10",
      borderColor: "border-apest-teacher/30",
      courses: [
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-trimtab-blue-4 mb-8 text-center">Course Benefits</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <Card key={index} className="text-center h-full border-trimtab-gray-2">
                <CardHeader>
                  <div className="w-12 h-12 bg-trimtab-blue-0 rounded-full flex items-center justify-center mx-auto mb-4">
                    <benefit.icon className="w-6 h-6 text-trimtab-blue-2" />
                  </div>
                  <CardTitle className="text-lg text-trimtab-blue-4">{benefit.title}</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-trimtab-gray-4 text-sm">{benefit.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-trimtab-gray-3 text-center mb-12 max-w-4xl mx-auto">
              ...
              <Card key={index} className={`${path.bgColor} ${path.borderColor} hover:shadow-lg transition-shadow duration-300`}>
                <CardHeader>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <CardTitle className="text-xl text-trimtab-blue-4">{path.title}</CardTitle>
                  </div>
                  <p className="text-trimtab-gray-4">{path.description}</p>
                </CardHeader>
                <CardContent>
                  <div className="mb-6">
                    <h4 className="font-semibold text-trimtab-blue-4 mb-3">Sample Courses:</h4>
                    <ul className="space-y-2">
                      {path.courses.map((course, idx) => (
                        <li key={idx} className="flex items-start gap-2 text-sm text-trimtab-gray-4">
                  ...
                  <Button className="w-full border-trimtab-blue-2 text-trimtab-blue-2 hover:bg-trimtab-blue-0" variant="outline" asChild>
                    <Link href={path.href}>
                      Explore Pathway
        ...
        <div className="mb-16">
          <Card className="bg-gradient-to-r from-trimtab-blue-0 to-trimtab-blue-1 border-trimtab-blue-2">
            <CardHeader>
              <CardTitle className="text-2xl text-center text-trimtab-blue-4">Learning Experience</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  <Clock className="w-8 h-8 text-trimtab-blue-2 mx-auto mb-3" />
                  <h3 className="font-semibold mb-2 text-trimtab-blue-4">Self-Paced Learning</h3>
                  <p className="text-trimtab-gray-4 text-sm">
                    Progress through courses at your own speed with lifetime access to materials
                  </p>
                </div>
                <div>
                  <Users className="w-8 h-8 text-trimtab-blue-2 mx-auto mb-3" />
                  <h3 className="font-semibold mb-2 text-trimtab-blue-4">Community Support</h3>
